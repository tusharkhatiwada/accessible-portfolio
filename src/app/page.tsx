      ...
      <Container className="mt-9">
        <div className="max-w-2xl">
          <h1 className="text-4xl font-bold tracking-tight text-zinc-800 dark:text-zinc-100 sm:text-5xl">
            Fullstack developer, Primarily focused on frontend development.
          </h1>
          <p className="mt-6 text-base text-zinc-600 dark:text-zinc-200">
            I’m Tushar, a fullstack developer based in Kathmandu City. Primarily
            focused on frontend development. Extensive experience in building
            web and mobile applications using React, Next.js, Tailwind CSS,
            React Native, Node.js, Express.js, MongoDB, PostgreSQL, GraphQL and
            more.
          </p>
